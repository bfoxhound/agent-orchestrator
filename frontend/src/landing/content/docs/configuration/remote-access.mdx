<<<<<<< Updated upstream:frontend/src/landing/content/docs/configuration/remote-access.mdx
---
title: Remote Access
...
- [Projects](/docs/configuration/projects) — per-project behavior options
- [Troubleshooting](/docs/troubleshooting) — connection and port issues
>>>>>>> Stashed changes:website/content/docs/configuration/remote-access.mdx
