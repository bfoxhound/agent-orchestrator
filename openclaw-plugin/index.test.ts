...
import { extractConfiguredReposFromYaml, fetchIssues, mergeStringLists, parseStringArraySetting } from "./index.ts";
...
test("allowlist helpers preserve existing entries while adding AO requirements", () => {
	...
	assert.deepEqual(parseStringArraySetting('["group:plugins","custom:tools"]'), ["group:plugins", "custom:tools"]);
