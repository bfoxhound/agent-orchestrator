...
import { getAgent, getAgentByName, getAgentByNameFromRegistry, getSCMFromRegistry } from "../../src/lib/plugins.js";
...
function makeRegistry(entries: { agent?: Record<string, Agent>; scm?: Record<string, SCM> }): PluginRegistry {
	return {
		register: () => {},
		get: (slot, name) => {
