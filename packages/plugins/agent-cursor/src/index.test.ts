...
const { mockAppendActivityEntry, mockReadLastActivityEntry, mockRecordTerminalActivity } = vi.hoisted(() => ({
...
describe("getLaunchCommand", () => {
	...
	it("prepends inline systemPrompt to prompt when systemPromptFile not provided", () => {
		const cmd = agent.getLaunchCommand(makeLaunchConfig({ systemPrompt: "You are an expert.", prompt: "Do the task" }));
