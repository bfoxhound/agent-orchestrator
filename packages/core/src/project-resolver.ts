import { ProjectResolveError, type DegradedProjectEntry, type LoadedConfig, type ProjectConfig } from "./types.js";
...
export function* iterateAllProjects(config: LoadedConfig): Iterable<ProjectConfig | DegradedProjectEntry> {
