...
export type { TransitionSource, TransitionResult, ApplyDecisionInput } from "./lifecycle-transition.js";
...
export type { ReportWatcherTrigger, ReportAuditResult, ReportWatcherConfig } from "./report-watcher.js";
...
export { getOrchestratorSessionId, normalizeOrchestratorSessionStrategy } from "./orchestrator-session-strategy.js";
...
export { setupPathWrapperWorkspace, buildAgentPath, PREFERRED_GH_PATH } from "./agent-workspace-hooks.js";
...
export { createCorrelationId, createProjectObserver, readObservabilitySummary } from "./observability.js";
...
export { getUpdateCheckCachePath, readUpdateCheckCacheRaw, getInstalledAoVersion } from "./update-cache.js";
...
export type { ParsedRepoUrl, ScmPlatform, DetectedProjectInfo, GenerateConfigOptions } from "./config-generator.js";

// Portfolio — cross-project aggregation
export type { PortfolioProject, PortfolioPreferences, PortfolioRegistered, PortfolioSession } from "./types.js";
...
export { resolvePortfolioProject, resolvePortfolioSession, derivePortfolioProjectId } from "./portfolio-routing.js";

// Storage V2 migration — one-time converter from hash-based to projectId-based layout
export { migrateStorage, rollbackStorage, inventoryHashDirs, convertKeyValueToJson } from "./migration/storage-v2.js";
export type { MigrationOptions, MigrationResult, RollbackOptions, HashDirEntry } from "./migration/storage-v2.js";
...
export { queryActivityEvents, searchActivityEvents, getActivityEventStats } from "./query-activity-events.js";
