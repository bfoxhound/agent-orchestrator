import type { ActivitySignal, RuntimeHandle, Session, SessionId, SessionKind, SessionStatus } from "../types.js";
...
export function sessionFromMetadata(
	...
	return {
		...
		restoredAt: options.restoredAt ?? (meta["restoredAt"] ? new Date(meta["restoredAt"]) : undefined),
		metadata: meta,
	};
}
