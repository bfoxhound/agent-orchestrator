...
import { isTmuxAvailable, listSessions, hasSession, sendKeys, capturePane, killSession, getPaneTTY } from "../tmux.js";
...
describe("listSessions", () => {
	it("parses tmux session list", async () => {
		mockTmuxSuccess("app-1\tMon Jan  1 00:00:00 2025\t0\t2\n" + "app-2\tTue Jan  2 00:00:00 2025\t1\t1\n");
