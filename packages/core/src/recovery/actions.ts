import type { CanonicalSessionLifecycle, OrchestratorConfig, PluginRegistry, Runtime, Workspace } from "../types.js";
import { recordActivityEvent } from "../activity-events.js";
import { updateMetadata } from "../metadata.js";
import { getProjectSessionsDir } from "../paths.js";
import { validateStatus } from "../utils/validation.js";
import { sessionFromMetadata } from "../utils/session-from-metadata.js";
import { buildLifecycleMetadataPatch, cloneLifecycle, parseCanonicalLifecycle } from "../lifecycle-state.js";
...
function buildLifecycleRecoveryPatch(
	...
	updated.session = {
		...
		terminatedAt: next.state === "terminated" ? (next.terminatedAt ?? nowIso) : updated.session.terminatedAt,
	};
...
export async function recoverSession(
	...
	const recoveryCount = rawMetadata["recoveryCount"] ? parseInt(rawMetadata["recoveryCount"], 10) + 1 : 1;
