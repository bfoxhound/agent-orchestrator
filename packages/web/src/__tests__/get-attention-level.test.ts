...
describe("getAttentionLevel", () => {
	...
	describe("simple mode", () => {
		...
		it("collapses stuck/errored statuses into action", () => {
			expect(getAttentionLevel(makeSession({ status: "stuck", activity: "idle" }), "simple")).toBe("action");
			expect(getAttentionLevel(makeSession({ status: "errored", activity: "idle" }), "simple")).toBe("action");
		});
