...
const IDENTITY_FIELD_TOOLTIP = "These describe which repo this is. Change them via `ao project relink`.";
		...
		<div className="project-settings-form">
			<section className="project-settings-form__section">
				...
				<div className="project-settings-form__grid">
					<EditableField id="agent" label="Agent" value={agent} onChange={setAgent} placeholder="claude-code" />
					<EditableField id="runtime" label="Runtime" value={runtime} onChange={setRuntime} placeholder="tmux" />
					<EditableField
						id="tracker-plugin"
				...
				{networkError ? (
					<div className="project-settings-form__alert project-settings-form__alert--surface">
						...
						<button type="button" onClick={() => void submit()} className="project-settings-form__retry">
							Retry
						</button>
					</div>
				) : null}
