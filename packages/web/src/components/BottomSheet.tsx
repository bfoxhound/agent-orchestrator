		...
		<>
			...
			>
					...
					<>
						...
						<div className="bottom-sheet__session-info">
							...
							<div className="bottom-sheet__session-meta">
								{tags.map((tag) => (
									<span key={`${tag.tone}-${tag.label}`} className={`bottom-sheet__tag bottom-sheet__tag--${tag.tone}`}>
										{tag.label}
									</span>
								))}
							</div>
						...
						<div className="bottom-sheet__preview-card">
							...
							<div className="bottom-sheet__preview-content">
								...
								<div className="bottom-sheet__preview-meta">
									{session.branch ? <span className="bottom-sheet__preview-branch">{session.branch}</span> : null}
				...
				<div className="bottom-sheet__actions">
					{mode === "confirm-kill" ? (
						<>
							<button type="button" className="bottom-sheet__btn bottom-sheet__btn--cancel" onClick={onCancel}>
								Cancel
							</button>
							<button type="button" className="bottom-sheet__btn bottom-sheet__btn--danger" onClick={onConfirm}>
								Terminate
							</button>
						</>
					) : (
						<>
							...
							{isMergeReady && session.pr && onMerge ? (
								...
								<button type="button" className="bottom-sheet__btn bottom-sheet__btn--danger" onClick={onRequestKill}>
									<svg
