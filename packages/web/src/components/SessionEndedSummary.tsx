...
export function SessionEndedSummary({ session, headline, pr, dashboardHref }: SessionEndedSummaryProps) {
			...
			<div className="session-ended-summary__panel">
				...
				<div className="session-ended-summary__body">
					...
					<div className="session-ended-summary__links">
						{pr ? (
							<a href={pr.url} target="_blank" rel="noopener noreferrer" className="session-ended-summary__primary">
								Open PR #{pr.number}
							</a>
						) : null}
