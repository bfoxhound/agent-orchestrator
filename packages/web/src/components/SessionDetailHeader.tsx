...
export function SessionDetailHeader({
	...
	const headerProjectLabel = projects.find((project) => project.id === session.projectId)?.name ?? session.projectId;
	...
	return (
		<header className="dashboard-app-header">
			...
			{showHeaderProjectLabel && <span className="dashboard-app-header__sep topbar-desktop-only" aria-hidden="true" />}
			<div className="topbar-project-pills-group">
				<div className="topbar-project-line">
					{showHeaderProjectLabel && <span className="dashboard-app-header__project">{headerProjectLabel}</span>}
				...
				<div className="topbar-session-pills">
					...
					{isOrchestrator && orchestratorZones ? <OrchestratorZonePills zones={orchestratorZones} /> : null}
				</div>
			</div>
			...
			<div className="dashboard-app-header__actions">
				...
				{isRestorable ? (
					<button type="button" className="dashboard-app-btn dashboard-app-btn--restore" onClick={onRestore}>
					...
					<button type="button" className="dashboard-app-btn dashboard-app-btn--danger" onClick={onKill}>
