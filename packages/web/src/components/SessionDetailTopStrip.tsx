...
import { activityStateClass, activityToneClass, buildGitHubBranchUrl } from "./session-detail-utils";
	...
	return (
		<div className="session-detail-top-strip">
			...
			<div className="session-detail-identity">
				<div className="session-detail-identity__info">
					...
					<div className="session-detail-identity__pills">
						<div className={cn("session-detail-status-pill", activityStateClass(activityLabel))}>
							<span className={cn("session-detail-status-pill__dot", activityToneClass(activityColor))} />
						...
						{branch ? (
							pr ? (
								...
								<span className="session-detail-link-pill session-detail-link-pill--branch">{branch}</span>
							)
						) : null}
						{pr ? (
							<a
				...
				{rightSlot ? (
					<div className="session-detail-identity__actions session-detail-identity__actions--custom">{rightSlot}</div>
				) : (
