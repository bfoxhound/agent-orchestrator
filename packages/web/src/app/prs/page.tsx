...
export async function generateMetadata(props: { searchParams: Promise<{ project?: string }> }): Promise<Metadata> {
...
export default async function PullRequestsRoute(props: { searchParams: Promise<{ project?: string }> }) {
	const searchParams = await props.searchParams;
	const projectFilter = resolveDashboardProjectFilter(searchParams.project);
