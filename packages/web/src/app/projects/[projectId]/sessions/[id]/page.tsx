...
export default function ProjectSessionPage() {
	...
	const fetchSession = useCallback(async () => {
		...
		try {
			...
			if (sessionFetchControllerRef.current === controller) sessionFetchControllerRef.current = null;
	...
	const fetchProjectSessions = useCallback(async () => {
		...
		try {
			...
			const orchestratorId =
				body.orchestratorId ?? body.orchestrators?.find((o) => o.projectId === projectId)?.id ?? null;
			...
			if (projectSessionsFetchControllerRef.current === controller) projectSessionsFetchControllerRef.current = null;
		}
	}, []);
