...
describe("ProjectLayoutClient", () => {
	it("renders children and sidebar", () => {
		render(
			<ProjectLayoutClient initialSessions={[]} initialProjects={projects} initialOrchestrators={[]}>
	...
	it("passes initialOrchestrators directly to sidebar", () => {
		render(
			<ProjectLayoutClient initialSessions={[]} initialProjects={projects} initialOrchestrators={orchestrators}>
				<div />
			</ProjectLayoutClient>,
		);
