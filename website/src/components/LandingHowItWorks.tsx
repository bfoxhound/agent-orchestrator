			...
			<div className="mt-20 flex flex-col gap-20">
				...
				<div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
					<div>
						...
						<p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
							Point Agent Orchestrator at your repo with a YAML config. Choose your agent, set up trackers and
							notifiers. One file, full control.
						</p>
					</div>
				...
				<div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
					<div className="md:order-2">
						...
						<p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
							Each agent spawns in an isolated worktree. They write code, create PRs, run tests, and fix failures.
							Monitor everything from the live dashboard, or let them run.
						</p>
					</div>
				...
				<div className="landing-reveal grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
					<div>
						...
						<p className="text-[var(--landing-muted)] text-[0.9375rem] leading-[1.7] max-w-[28rem]">
							Agents create pull requests, address review comments, fix CI failures, and get them to mergeable state.
							Your morning starts with merged PRs, not a backlog.
						</p>
					</div>
